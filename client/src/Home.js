    ...
    return (
      ...
      {/* About section/ end of header*/}
        <div class="card">
          ...
          {/* About Joga */}
          <div class="card-body">
            <h5 class="card-title">Joga Amsterdam's Foundation </h5>
            <p class="card-text">Joga Amsterdam started in the year (????) in Washington D.C. with the goal of exposing American children to soccer culture.
